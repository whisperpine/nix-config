...
- [section-separator](./section-separator/SKILL.md)
...
- [grill-me](./grill-me/SKILL.md) (user-invoked)
...
- [to-prd](./to-prd/SKILL.md) (user-invoked)
- [write-skills](./write-skills/SKILL.md) (user-invoked)
...
These skills are installed from external sources and kept intact
(see [.skill-lock.json](../vercel-skills/.skill-lock.json)).
