...
- Show relationships. Use term names and express cardinality where obvious.
...
- Fulfillment, Billing: Fulfillment emits `ShipmentDispatched` events; Billing
  consumes them to generate invoices.
